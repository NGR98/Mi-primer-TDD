...
public class TestCoche {
    ...
    @Test
    public void test_al_decelerar_un_coche_su_velocidad_disminuye_Nicolas_Gil_Ruiz(){
        Coche nuevoCoche = new Coche();
    ...
    @Test
    public void test_al_decelerar_un_coche_su_velocidad_no_puede_ser_menor_que_cero_Nicolas_Gil_Ruiz(){
        Coche nuevoCoche = new Coche();
        nuevoCoche.velocidad = 50;
